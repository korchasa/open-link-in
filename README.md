...
- **Режим «Всегда спрашивать»**: вместо браузера у правила можно выбрать пункт
  «Всегда спрашивать» — тогда каждая ссылка на этот домен открывает окно выбора,
  а выбор не запоминается.
